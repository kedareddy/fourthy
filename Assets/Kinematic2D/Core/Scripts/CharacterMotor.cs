...
public class CharacterMotor : MotionCustomBehaviour
{
	...
	// 		characterBody.center_FullStepOffset ,
	// 		characterBody.boxSize_FullStepOffset ,
	// 		0 ,
	// 		overlappedColliders
	// 	);
	...
	// 		if ( overlappedCollider == col2D )
	// 			continue;

	// 		ColliderDistance2D colliderDistance = overlappedCollider.Distance( col2D );

	// 		if (colliderDistance.isOverlapped)
	// 		{
	// 			//Debug.DrawLine( colliderDistance.pointA , colliderDistance.pointB , Color.red );
	// 			characterBody.bodyTransform.Translate(colliderDistance.pointA - colliderDistance.pointB);
	// 		}
	// 	}
	// }
